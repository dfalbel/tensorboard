...
PROTOBUF_NAMESPACE_OPEN
template<> ::tensorboard::TensorShapeProto* Arena::CreateMaybeMessage<::tensorboard::TensorShapeProto>(Arena*);
template<> ::tensorboard::TensorShapeProto_Dim* Arena::CreateMaybeMessage<::tensorboard::TensorShapeProto_Dim>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorboard {
