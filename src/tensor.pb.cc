...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_tensor_2eproto[2];
...
const uint32_t TableStruct_tensor_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, dtype_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, tensor_shape_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, version_number_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, tensor_content_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, half_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, float_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, double_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, int_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, string_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, scomplex_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, int64_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, bool_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, dcomplex_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, resource_handle_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, variant_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, uint32_val_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorProto, uint64_val_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::tensorboard::VariantTensorDataProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::tensorboard::VariantTensorDataProto, type_name_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::VariantTensorDataProto, metadata_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::VariantTensorDataProto, tensors_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::tensorboard::TensorProto)},
  { 23, -1, -1, sizeof(::tensorboard::VariantTensorDataProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tensorboard::_TensorProto_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tensorboard::_VariantTensorDataProto_default_instance_),
};

const char descriptor_table_protodef_tensor_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014tensor.proto\022\013tensorboard\032\025resource_ha"
  "ndle.proto\032\022tensor_shape.proto\032\013types.pr"
  "oto\"\220\004\n\013TensorProto\022$\n\005dtype\030\001 \001(\0162\025.ten"
  "sorboard.DataType\0223\n\014tensor_shape\030\002 \001(\0132"
  "\035.tensorboard.TensorShapeProto\022\026\n\016versio"
  "n_number\030\003 \001(\005\022\026\n\016tensor_content\030\004 \001(\014\022\024"
  "\n\010half_val\030\r \003(\005B\002\020\001\022\025\n\tfloat_val\030\005 \003(\002B"
  "\002\020\001\022\026\n\ndouble_val\030\006 \003(\001B\002\020\001\022\023\n\007int_val\030\007"
  " \003(\005B\002\020\001\022\022\n\nstring_val\030\010 \003(\014\022\030\n\014scomplex"
  "_val\030\t \003(\002B\002\020\001\022\025\n\tint64_val\030\n \003(\003B\002\020\001\022\024\n"
  "\010bool_val\030\013 \003(\010B\002\020\001\022\030\n\014dcomplex_val\030\014 \003("
  "\001B\002\020\001\022=\n\023resource_handle_val\030\016 \003(\0132 .ten"
  "sorboard.ResourceHandleProto\0228\n\013variant_"
  "val\030\017 \003(\0132#.tensorboard.VariantTensorDat"
  "aProto\022\026\n\nuint32_val\030\020 \003(\rB\002\020\001\022\026\n\nuint64"
  "_val\030\021 \003(\004B\002\020\001\"h\n\026VariantTensorDataProto"
  "\022\021\n\ttype_name\030\001 \001(\t\022\020\n\010metadata\030\002 \001(\014\022)\n"
  "\007tensors\030\003 \003(\0132\030.tensorboard.TensorProto"
  "B|\n\030org.tensorflow.frameworkB\014TensorProt"
  "osP\001ZMgithub.com/tensorflow/tensorflow/t"
  "ensorflow/go/core/framework/tensor_go_pr"
  "oto\370\001\001b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_tensor_2eproto_deps[3] = {
  &::descriptor_table_resource_5fhandle_2eproto,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensor_2eproto = {
  false, false, 854, descriptor_table_protodef_tensor_2eproto, "tensor.proto", 
  &descriptor_table_tensor_2eproto_once, descriptor_table_tensor_2eproto_deps, 3, 2,
...
TensorProto::TensorProto(const TensorProto& from)
  ...
  if (from._internal_has_tensor_shape()) {
    tensor_shape_ = new ::tensorboard::TensorShapeProto(*from.tensor_shape_);
  } else {
    tensor_shape_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:tensorboard.TensorProto)
  ...
  if (from._internal_has_tensor_shape()) {
    _internal_mutable_tensor_shape()->::tensorboard::TensorShapeProto::MergeFrom(from._internal_tensor_shape());
  }
...
VariantTensorDataProto::VariantTensorDataProto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:tensorboard.VariantTensorDataProto)
}
VariantTensorDataProto::VariantTensorDataProto(const VariantTensorDataProto& from)
  ...
  // @@protoc_insertion_point(copy_constructor:tensorboard.VariantTensorDataProto)
}
...
VariantTensorDataProto::~VariantTensorDataProto() {
  // @@protoc_insertion_point(destructor:tensorboard.VariantTensorDataProto)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:tensorboard.VariantTensorDataProto)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "tensorboard.VariantTensorDataProto.type_name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* VariantTensorDataProto::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:tensorboard.VariantTensorDataProto)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_type_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "tensorboard.VariantTensorDataProto.type_name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tensorboard.VariantTensorDataProto)
  return target;
}

size_t VariantTensorDataProto::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tensorboard.VariantTensorDataProto)
  size_t total_size = 0;
...
void VariantTensorDataProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<VariantTensorDataProto *>(to)->MergeFrom(
      static_cast<const VariantTensorDataProto &>(from));
}


void VariantTensorDataProto::MergeFrom(const VariantTensorDataProto& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tensorboard.VariantTensorDataProto)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:tensorboard.VariantTensorDataProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VariantTensorDataProto::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_tensor_2eproto_getter, &descriptor_table_tensor_2eproto_once,
      file_level_metadata_tensor_2eproto[1]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace tensorboard
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::tensorboard::TensorProto* Arena::CreateMaybeMessage< ::tensorboard::TensorProto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorboard::TensorProto >(arena);
}
template<> PROTOBUF_NOINLINE ::tensorboard::VariantTensorDataProto* Arena::CreateMaybeMessage< ::tensorboard::VariantTensorDataProto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorboard::VariantTensorDataProto >(arena);
}
