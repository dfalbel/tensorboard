...
template <> struct is_proto_enum< ::tensorboard::DataType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorboard::DataType>() {
  return ::tensorboard::DataType_descriptor();
}
