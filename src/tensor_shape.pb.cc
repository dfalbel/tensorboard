...
const uint32_t TableStruct_tensor_5fshape_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorShapeProto_Dim, size_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorShapeProto_Dim, name_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorShapeProto, dim_),
  PROTOBUF_FIELD_OFFSET(::tensorboard::TensorShapeProto, unknown_rank_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::tensorboard::TensorShapeProto_Dim)},
  { 8, -1, -1, sizeof(::tensorboard::TensorShapeProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tensorboard::_TensorShapeProto_Dim_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tensorboard::_TensorShapeProto_default_instance_),
};
...
const char descriptor_table_protodef_tensor_5fshape_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "sorShapeProto\022.\n\003dim\030\002 \003(\0132!.tensorboard"
  ".TensorShapeProto.Dim\022\024\n\014unknown_rank\030\003 "
  "\001(\010\032!\n\003Dim\022\014\n\004size\030\001 \001(\003\022\014\n\004name\030\002 \001(\tB\207"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensor_5fshape_2eproto = {
  false, false, 304, descriptor_table_protodef_tensor_5fshape_2eproto, "tensor_shape.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "tensorboard.TensorShapeProto.Dim.name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* TensorShapeProto_Dim::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "tensorboard.TensorShapeProto.Dim.name");
...
template<> PROTOBUF_NOINLINE ::tensorboard::TensorShapeProto_Dim* Arena::CreateMaybeMessage< ::tensorboard::TensorShapeProto_Dim >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorboard::TensorShapeProto_Dim >(arena);
}
template<> PROTOBUF_NOINLINE ::tensorboard::TensorShapeProto* Arena::CreateMaybeMessage< ::tensorboard::TensorShapeProto >(Arena* arena) {
